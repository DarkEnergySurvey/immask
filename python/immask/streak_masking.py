...
and scipy dependencies, requires:
...
class STREAK:
    ...
    def __init__(self,parent=None,**keys):
        ...
        # If parent object present
        if parent:
            self.OUT_SCI  = parent.OUT_SCI
            self.OUT_MSK  = parent.OUT_MSK
            self.OUT_WGT  = parent.OUT_WGT
            self.outdir   = parent.outdir
    ...
    def setImage(self,**keys):
    
        self.fileName  = extract_filename(keys.get('fileName'))
...
# ******************************************************************************************
# Auxiliary function not part of the core streak finder, required for stand-alone version
def extract_filename(filename):
    """
    Safe extraction of a filename, taken from fitsio
    """
